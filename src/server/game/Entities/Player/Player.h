...
class Player : public Unit, public GridObject<Player>
{
    ...
    public:
		...
		uint32 GetKillstreak() const { return m_killstreak; }
		uint32 GetHighestKillstreak() const { return m_highest_killstreak; }
		void SetKillstreak(uint32 value) { m_killstreak = value; }
		void SetHighestKillstreak(uint32 value) { m_highest_killstreak = value; }
